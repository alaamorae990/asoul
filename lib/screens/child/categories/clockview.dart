...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint()..color = clockBG;
    var outlineBrush = Paint()
      ..color = clockOutline
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width / 20;
    var centerDotBrush = Paint()..color = clockOutline;

    var secHandBrush = Paint()
      ..color = Styles.secHandColor!
      ..style = PaintingStyle.stroke
      ..strokeCap = StrokeCap.round
      ..strokeWidth = size.width / 60;

    var minHandBrush = Paint()
      ..shader = RadialGradient(colors: [minHandStatColor, minHandEndColor])
    ...
    var hourHandBrush = Paint()
      ..shader = RadialGradient(colors: [hourHandStatColor, hourHandEndColor])
          .createShader(Rect.fromCircle(center: center, radius: radius))
      ..style = PaintingStyle.stroke
      ..strokeCap = StrokeCap.round
