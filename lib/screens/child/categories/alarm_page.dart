      ...
      child: Column(
        ...
        children: <Widget>[
          const Text(
            'المنبه',
            style:
            TextStyle(fontFamily: 'avenir', fontWeight: FontWeight.w700, color: primaryTextColor, fontSize: 24),
          ),
          Expanded(
                            ...
                            child: MaterialButton(
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Text(
                                    'اضف منبه',
                                    style: TextStyle(color: Colors.white, fontFamily: 'avenir',fontSize: 24),
                                  ),
                                ],
                              ),
                            ),
